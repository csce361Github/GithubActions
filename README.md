[![Run App]([![Run App <Meyer>, <Adam>](https://github.com/ameyer69/GithubActions/actions/workflows/ci.yml/badge.svg)](https://github.com/ameyer69/GithubActions/actions/workflows/ci.yml))
