[![Run App Vasa, Lance](https://github.com/LanceVasa/GithubActions/actions/workflows/ci.yml/badge.svg)](https://github.com/LanceVasa/GithubActions/actions/workflows/ci.yml)
