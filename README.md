[![Run App Larsen, Rhett](https://github.com/rhlarse/GithubActions/actions/workflows/ci.yml/badge.svg)](https://github.com/rhlarse/GithubActions/actions/workflows/ci.yml)
