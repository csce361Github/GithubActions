[![Run App <Krause>, <Eleanor>](https://github.com/EllaKrause/GithubActions/actions/workflows/ci.yml/badge.svg)](https://github.com/EllaKrause/GithubActions/actions/workflows/ci.yml)
