[![Run App Kvasnicka, Ethan](https://github.com/ekvasnicka/GithubActions/actions/workflows/ci.yml/badge.svg)](https://github.com/ekvasnicka/GithubActions/actions/workflows/ci.yml)
