[![Run App <last name>, <first name>](https://github.com/atimothy3/GithubActions/actions/workflows/ci.yml/badge.svg)](https://github.com/atimothy3/GithubActions/actions/workflows/ci.yml)
