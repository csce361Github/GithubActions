...
public class Addition
{
	...
	public void Add_Valid_Patino()
	{
		...
		Assert.AreEqual(12, Program.Add("3", "7"));
	}
...
public class Division
{
    ...
    public void Divide_Valid_Patino()
    {
        ...
        Assert.AreEqual(0.42857142857142855, Program.Divide("3", "7"), 1e-9);  // Tolerance for floating point
    }

    [TestMethod]
	public void Divide_ByZero_Patino()
	{
		var result = Program.Divide("1", "0");
		Assert.AreEqual(double.PositiveInfinity, result, "Division by zero should result in Infinity.");
	}
